...
var appRoutes = [
    ...
    { path: 'remove_contato/:id/:ret', component: contatos_remove_component_1.ContatosRemoveComponent },
    { path: 'contatos_cons_nome', component: contatos_cons_nome_component_1.ContatosConsNomeComponent },
    { path: 'contatos_cons_nome/:remocao', component: contatos_cons_nome_component_1.ContatosConsNomeComponent },
    { path: 'jquery', component: jquery_component_1.JQueryComponent },
];
